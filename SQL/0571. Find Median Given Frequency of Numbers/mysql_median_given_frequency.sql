...
-- For example, [1, 5, 2, 7], the median number for this array should be (2 + 5) / 7. For 2, only 1 is smaller than it, and 5, 7 is bigger than it. 
-- For 5, 1 and 2 is smaller than it, only 7 is bigger than it. Either of 2 or 5, the difference(absolute value) of its bigger and smaller number than itself 
-- in this array is 1, which is the exactly frequency of a element in the distinct array.
